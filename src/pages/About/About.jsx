      ...
      <div className="container about-container-item">
        ...
        <div className="about-container-hover">
          <div className="about-container">
            I am a final year computer science engineering undergrad with a
            passion for front-end development. I have a keen interest in
            contributing to open-source projects and have actively participated
            in various Open Source programs. I truly enjoy being part of a
            community where I can learn from others and contribute my skills.
            Currently, I am working towards becoming a Full Stack Developer with
            a specialization in the MERN stack.
          </div>
        </div>
        <div className="heading-container">
        ...
        <div className="btn-container skills-btn">
          <Buttons
            ...
            isActive={activeButton === "Web Technologies"}
          />
          <Buttons
            name="Languages"
            onClick={handleButtonClick}
            isActive={activeButton === "Languages"}
          />
          <Buttons
            name="Design Tools"
            onClick={handleButtonClick}
            isActive={activeButton === "Design Tools"}
          />
        </div>
