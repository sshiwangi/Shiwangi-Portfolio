  ...
  const experiences = [
    {
      ...
      desc: "Mentoring contributors by helping them understand project goals, contribution guidelines, and best practices, revieweing code contributions and providing constructive feedback and assigning task based on thier skills and interests",
      skill: "React JS, TypeScript, HTML, CSS, JavaScript, Git/GitHub",
    },
    {
      id: 2,
      image: gssoc,
      ...
      skill:
        "React JS, Node JS, Express JS, Mongo DB, HTML, CSS, JavaScript, Bootstrap, DSA",
    },
    {
      id: 3,
      image: hacktoberfest,
